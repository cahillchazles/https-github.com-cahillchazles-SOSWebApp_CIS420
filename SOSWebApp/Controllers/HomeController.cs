    ...
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> Contact(EmailFormModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                message.To.Add(new MailAddress("zach.spalding@gmail.com"));  // replace with valid value 
                ...
                using (var smtp = new SmtpClient())
                {
                    ...
                    {
                        UserName = "soslouisville@outlook.com",  // replace with valid value
                        Password = "TheBTeam!"  // replace with valid value
                    };
